...
This repo is the plugin marketplace registry for Agiterra's Claude Code plugins. To install:
...
This repo only contains the marketplace JSON. To learn what Agiterra is, how it fits together, and how to set it up properly:
